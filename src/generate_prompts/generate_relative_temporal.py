...
def generate_data():
    ...
    with open('../resources/data/relative_temporal_data.json', 'w') as f:
...
def generate_prompts_from_tr_data():
    ...
    with open('../resources/data/relative_temporal_data.json', 'r') as f:
        tr_data = json.load(f)
    ...
    with open('../resources/generated_prompts/30_prompts_relative_temporal_3_types.json', 'w') as f:
